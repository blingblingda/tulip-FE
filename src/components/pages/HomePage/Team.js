...
// Define a dictionary for the social media colors
const socialColors = {
  portfolio: 'text-[#39569c]', // Portfolio brand color
  linkedin: 'text-[#00acee]', // LinkedIn brand color
  github: 'text-[#bd2c00]', // GitHub brand color
};

// Define a dictionary for the SVG content for each social media icon
const socialIconContent = {
  portfolio: (
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6.487 1.746c0 4.192 3.592 1.66 4.592 5.754 0 .828 1 1.5 2 1.5s2-.672 2-1.5a1.5 1.5 0 0 1 1.5-1.5h1.5m-16.02.471c4.02 2.248 1.776 4.216 4.878 5.645C10.18 13.61 9 19 9 19m9.366-6h-2.287a3 3 0 0 0-3 3v2m6-8a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
  ),
  linkedin: (
    <>
...
const SocialIcon = ({ network, link }) => {
  const viewBox = network === 'linkedin' ? "0 0 15 15" 
                : network === 'github' ? "0 0 20 20" 
                : network === 'portfolio' ? "0 0 21 20" 
                : "0 0 24 24"; // default case

  return (
    <a
      href={link}
      className={`inline-block text-gray-500 dark:text-gray-400 hover:${socialColors[network]} transition-transform duration-300 ease-in-out transform hover:scale-110`} // Apply transition and hover styles
    >
      <svg
  ...
  const teamMembers = [
    {
      ...
      imageUrl: sourabh,
      socialLinks: [
        { network: "linkedin", href: "https://www.linkedin.com/in/sourabhbeniwal1/" },
    ...
    },
    {
      ...
      imageUrl: belinda,
      socialLinks: [
        { network: "linkedin", href: "https://www.linkedin.com/in/belinda-shan-126bs414/" },
        { network: "github", href: "https://github.com/blingblingda" },
        { network: "portfolio", href: "https://blingblingda.github.io/react-resume-belinda/" },
      ],
    },
    {
      name: "Yu Ji",
      ...
      imageUrl: sophia,
      socialLinks: [
        { network: "linkedin", href: "https://www.linkedin.com/in/yu-ji-785718113/" },
        { network: "github", href: "https://github.com/YuJi-2023" },
        { network: "portfolio", href: "https://yuji-2023.github.io/index.html" },
      ],
    },
    {
      name: "Angella Lao",
      ...
      imageUrl: angella,
      socialLinks: [
        { network: "linkedin", href: "https://www.linkedin.com/in/angella-lao/" },
